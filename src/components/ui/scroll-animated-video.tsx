      ...
      if (smoothScroll) {
        ...
        if (LenisCtor) {
          lenis = new LenisCtor({
            ...
            wheelMultiplier: 0.8, // Reduzido para scroll mais rápido
            touchMultiplier: 0.8, // Reduzido para touch mais rápido
            ...lenisOptions,
          });
      ...
      if (showHeroExitAnimation && headline) {
        heroTl = gsap.timeline({
          scrollTrigger: {
            ...
            scrub: 0.8, // Reduzido de 1.1 para 0.8 para melhor performance
          },
        });
    ...
    return (
      <video
        ...
        onError={(e) => {
          ...
          console.error('Video src:', media);
        }}
        onLoadStart={() => {
          console.log('Video loading started:', media);
        }}
        onCanPlay={() => {
          console.log('Video can play:', media);
        }}
      >
        {sources}
      </video>
    ...
    >
      ...
      <style>{`
        ...
        .hsv-media {
          ...
          box-shadow: var(--shadow);
          will-change: transform, width, height; /* Otimização para GPU */
